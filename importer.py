...
class Importer(QtWidgets.QDialog):
    ...
    def build_ui(self):
        ...
        self.hd_checkbox = QtWidgets.QRadioButton("HD")
        self.hd_checkbox.setChecked(True)
        version_layout.addWidget(self.hd_checkbox)

        self.ld_checkbox = QtWidgets.QRadioButton("LD")
        self.ld_checkbox.setChecked(False)
        version_layout.addWidget(self.ld_checkbox)

        self.fml_checkbox = QtWidgets.QRadioButton("FML")
        self.fml_checkbox.setChecked(False)
        ...
        self.hd_checkbox.toggled.connect(self.get_version)
        self.hd_checkbox.toggled.connect(self.pass_populate)
        self.ld_checkbox.toggled.connect(self.get_version)
        self.ld_checkbox.toggled.connect(self.pass_populate)
        self.fml_checkbox.toggled.connect(self.get_version)
        self.fml_checkbox.toggled.connect(self.pass_populate)
